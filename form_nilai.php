...
<body>
    ...
    <form method="GET" action="form_nilai.php">
        ...
        <div class="form-group">
            <label class="form">Mata Kuliah</label>
            <select class="form-control" id="exampleFormControlSelect1" name="matkul">
                <option value="#" id="disabledInput">Pilih Mata Kuliah</option>
        ...
        <div class="form-group">
            <label class="form">Nilai UTS</label>
        ...
        <div class="form-group">
            <label class="form">Nilai UAS</label>
        ...
        <div class="form-group">
            <label class="form">Nilai Praktikum</label>
